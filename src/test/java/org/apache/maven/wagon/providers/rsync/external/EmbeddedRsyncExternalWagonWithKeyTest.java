 ...
 *
 */
public class EmbeddedRsyncExternalWagonWithKeyTest extends AbstractEmbeddedRsyncWagonWithKeyTest {


    @Override
    protected Wagon getWagon() throws Exception {
        RsyncExternalWagon scpWagon = (RsyncExternalWagon) super.getWagon();
